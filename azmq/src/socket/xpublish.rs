...
///
/// Same as [`Publish`](struct@super::Publish) except that you can receive subscriptions from the
/// peers in form of incoming messages. Subscription message is a byte 1 (for subscriptions) or
